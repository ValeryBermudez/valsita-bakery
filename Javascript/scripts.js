...
function proceedToPayment() {
    closeShoppingCart(); // Cerrar la ventana emergente del carrito de compras
    showPaymentModal(); // Mostrar la ventana emergente de pago
}

// Función para mostrar la ventana emergente de pago
...
// Ventana emergente para los detalles del producto --------------------------------------------------------------------------------------------------------------------------------
